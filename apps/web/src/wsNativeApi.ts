...
export function createWsNativeApi(): NativeApi {
  ...
  const api: NativeApi = {
    ...
    prHub: {
      ...
      acknowledgeAttention: (input) => requestPrHub(PR_HUB_WS_METHODS.acknowledgeAttention, input),
      ...
      prepareComment: (input) => requestPrHub(PR_HUB_WS_METHODS.prepareComment, input),
      submitComment: (input) => requestPrHub(PR_HUB_WS_METHODS.submitComment, input),
      getCommentOperation: (input) => requestPrHub(PR_HUB_WS_METHODS.getCommentOperation, input),
      recoverComment: (input) => requestPrHub(PR_HUB_WS_METHODS.recoverComment, input),
      prepareQuickReview: (input) => requestPrHub(PR_HUB_WS_METHODS.prepareQuickReview, input),
