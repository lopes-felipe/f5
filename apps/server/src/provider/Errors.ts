...
/**
 * ProviderValidationBusyError - Validation request already in progress.
 */
export class ProviderValidationBusyError extends Schema.TaggedErrorClass<ProviderValidationBusyError>()(
