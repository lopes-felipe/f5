...
export interface ProjectionTurnRepositoryShape {
   ...
   * concrete turn. Omit threadId for startup repair, including acknowledged deliveries.
   */
  ...
  /**
   * Looks up the newest concrete running turn row for a thread and never returns pending placeholder rows.
   */
