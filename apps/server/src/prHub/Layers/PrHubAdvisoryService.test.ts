...
function makePrHubStub(snapshot: PrHubSnapshot): PrHubServiceShape {
  return {
    ...
    prepareComment: () => Effect.die("unused"),
    submitComment: () => Effect.die("unused"),
    getCommentOperation: () => Effect.die("unused"),
    recoverComment: () => Effect.die("unused"),
    prepareQuickReview: () => Effect.die("Unexpected quick review"),
