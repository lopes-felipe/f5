...
const CompactionRecommendedPayload = Schema.Struct({
  ...
  thresholdTokens: NonNegativeInt,
  modelContextWindowTokens: NonNegativeInt,
});
export type CompactionRecommendedPayload = typeof CompactionRecommendedPayload.Type;
...
const McpServerStartupStatus = Schema.Literals(["starting", "ready", "failed", "cancelled"]);
...
const ProviderRuntimeMcpStatusUpdatedPayload = Schema.Struct({
  status: McpServerStatus,
});
export type ProviderRuntimeMcpStatusUpdatedPayload =
  typeof ProviderRuntimeMcpStatusUpdatedPayload.Type;
...
const ProviderRuntimeCompactionRecommendedEvent = Schema.Struct({
  ...
  payload: CompactionRecommendedPayload,
});
export type ProviderRuntimeCompactionRecommendedEvent =
  typeof ProviderRuntimeCompactionRecommendedEvent.Type;
...
const ProviderRuntimeMcpStatusUpdatedEvent = Schema.Struct({
  ...
  payload: ProviderRuntimeMcpStatusUpdatedPayload,
});
