...
const decodeProviderDriverKind = Schema.decodeUnknownSync(ProviderDriverKindSchema);
export const ProviderDriverKind = Object.assign(ProviderDriverKindSchema, {
  make: <T extends string>(value: T): T & typeof ProviderDriverKindSchema.Type =>
    decodeProviderDriverKind(value) as T & typeof ProviderDriverKindSchema.Type,
});
...
const decodeProviderInstanceId = Schema.decodeUnknownSync(ProviderInstanceIdSchema);
export const ProviderInstanceId = Object.assign(ProviderInstanceIdSchema, {
  make: <T extends string>(value: T): T & typeof ProviderInstanceIdSchema.Type =>
    decodeProviderInstanceId(value) as T & typeof ProviderInstanceIdSchema.Type,
});
