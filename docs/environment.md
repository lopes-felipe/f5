...
| `F5_GITHUB_OAUTH_CLIENT_ID`        | Public client ID of the F5 GitHub OAuth app with device flow enabled; unset disables browser GitHub sign-in. |
| `F5_PROFILE`                       | Profile slug or id; defaults to `default`. Each profile runs its own server.                                 |
